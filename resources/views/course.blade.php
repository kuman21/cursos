...
@section('content')
    <div class="grid grid-cols-3 gap-4">
        <div class="p-8 bg-gray-200 col-span-1">
            <ul class="flex flex-col">
                ...
                @foreach ($course->posts as $post)
                    <li class="flex item-center text-gray-600 mt-2">{{ $post->name }}</li>
                    @if ($post->free)
        ...
        <div class="text-gray-700 col-span-2">
            ...
            <h2 class="text-4xl mt-2">{{ $course->name }}</h2>
            <p>{{ $course->description }}</p>
            <div class="flex mt-3">
                <img src="{{ $course->user->profile_photo_url }}" class="h-10 w-10 rounded-full mr-2">
                <div>
    ...
    <div class="text-center mt-4">
        ...
        <h2 class="text-xl text-gray-600">Fórmate online como profesional de tecnología</h2>
    </div>
